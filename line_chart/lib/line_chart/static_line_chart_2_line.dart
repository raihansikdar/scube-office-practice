...
class HomePage extends StatelessWidget {
  ...
  final List<ChartDataModel> chartData2 = [
    ChartDataModel(year: 2010, sales: 8),
    ChartDataModel(year: 2011, sales: 18),
    ChartDataModel(year: 2012, sales: 10),
    ChartDataModel(year: 2013, sales: 25),
    ChartDataModel(year: 2014, sales: 45),
    ChartDataModel(year: 2015, sales: 10),
    ChartDataModel(year: 2016, sales: 20),
    ChartDataModel(year: 2017, sales: 5),
  ];
          ...
          child: SfCartesianChart(
            ...
            series: <CartesianSeries>[
              ...
              LineSeries<ChartDataModel, int>(
                ...
                // dashArray: const <double>[5, 5],
                pointColorMapper:(ChartDataModel data, _) => Colors.blue,
                xValueMapper: (ChartDataModel data, _)=> data.year,
                yValueMapper:  (ChartDataModel data, _)=>data.sales,
                dataLabelSettings: const DataLabelSettings(isVisible: true),
              ),
