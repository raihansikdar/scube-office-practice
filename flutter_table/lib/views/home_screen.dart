...
//   // final PVController _pvController = PVController();
...
//
//     final response1 = await http.get(Uri.parse(_baseUrl+inv1EndPoint));
//     final response2 = await http.get(Uri.parse(_baseUrl+inv2EndPoint));
//     final response3 = await http.get(Uri.parse(_baseUrl+inv3EndPoint));
//
//
//
//     log('====================');
...
//             child: FutureBuilder(
//               future: _pvController.getInv1Data(),
...
//                     ],
//                     rows: _pvController.invList.isNotEmpty
