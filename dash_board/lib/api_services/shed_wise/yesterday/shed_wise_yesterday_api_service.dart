...
class ShedWiseYesterdaysApiService {
  static Future<List<ShedWiseModel>> fetchShedWiseYesterdayData() async {
    final response = await http.get(Uri.parse('http://192.168.60.60:8000/shedwise-yesterday/'));
